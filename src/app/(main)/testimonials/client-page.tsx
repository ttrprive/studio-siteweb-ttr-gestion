...
import { Rating } from '@/components/testimonials-section';
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid gap-2">
                     ...
                     <div className="grid gap-2">
                        ...
                        <Input id="role" name="role" placeholder="Gérant de boutique" required />
                    </div>
                    <div className="grid gap-2">
                    ...
                    <div className="grid gap-2">
                        ...
                        <Textarea id="review" name="review" placeholder="TTR Gestion est incroyable..." required />
                    </div>
                    <DialogFooter>
...
export default function TestimonialsClientPage({ testimonials }: { testimonials: Testimonial[] }) {
