...
const ThreeDCard: React.FC = () => {
    ...
    useEffect(() => {
        ...
        // Lights
        const ambientLight = new THREE.AmbientLight(0xffffff, 1.0); // Ambient light for general illumination
        scene.add(ambientLight);

        // Directional light to cast shadows
        const directionalLight = new THREE.DirectionalLight(0xffffff, 3.0); // Increased intensity for brighter look
