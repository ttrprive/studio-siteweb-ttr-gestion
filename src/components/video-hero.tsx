...
export const VideoHero = () => {
    ...
    // Le paramètre "mute=1" a été retiré pour activer le son, mais cela peut empêcher l'autoplay.
    const videoSrc = "https://www.youtube.com/embed/LtJi5Eg0Kjk?si=xTqobDs2-j5-TSOq&autoplay=1&loop=1&playlist=LtJi5Eg0Kjk&controls=0&showinfo=0";
